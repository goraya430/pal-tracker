...
public class EnvController {
    ...
    public EnvController(@Value("${PORT:NOT SET}") String port, @Value("${MEMORY_LIMITNOT:NOT SET}") String memory_limit, @Value("${CF_INSTANCE_INDEX:NOT SET}") String cf_instance_index, @Value("${CF_INSTANCE_ADDR:NOT SET}") String cf_instance_addr) {
        this.port =port;
